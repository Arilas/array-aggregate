...
it('should work with dates', () => {
  ...
  expect(matcher([beginFnDate * 1, endDate * 1])).toBeTruthy()
  expect(matcher([endDate * 1, beginFnDate * 1])).toBeTruthy()
  expect(matcher([beginFnDate * 1, endDate * 1, new Date() * 1])).toBeTruthy()
  expect(matcher([new Date() * 1])).toBeFalsy()
})
